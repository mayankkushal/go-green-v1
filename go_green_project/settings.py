...
TWITTER_FEED_CONSUMER_PUBLIC_KEY = ('config')
TWITTER_FEED_CONSUMER_SECRET =('config')
TWITTER_FEED_OPEN_AUTH_TOKEN = ('config')
TWITTER_FEED_OPEN_AUTH_SECRET = ('config')
...
TWILIO_DEFAULT_CALLERID = ('config')
NO = ('config')
